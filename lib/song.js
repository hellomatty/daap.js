...
var Song = exports.Song = function(options) {
  ...
  this.artist = tags.artist || options.artist || options.file;
  this.name = tags.title || options.name || options.file;
  this.album = tags.album || options.album || options.file;

  sys.debug(this.name.length);
  sys.debug(this.name);
